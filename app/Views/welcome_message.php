...
<!-- Testimonial Section -->
<section class="py-section-gap px-margin-mobile md:px-margin-desktop bg-surface-container-lowest/50 relative overflow-hidden">
...
<span class="material-symbols-outlined text-[64px] text-primary/30" style="font-variation-settings: 'FILL' 1;">format_quote</span>
<h2 class="font-headline-lg text-on-background leading-tight">
                    "Bekerja dengan AzeriaDev adalah investasi terbaik untuk transformasi digital kami. Hasil kodenya sebersih desainnya, dan performanya luar biasa."
                </h2>
<div class="flex flex-col items-center gap-4">
<div class="w-16 h-16 rounded-full border-2 border-primary overflow-hidden">
<img class="w-full h-full object-cover" data-alt="A professional headshot of a female tech CEO in a modern corporate setting. She is wearing a tailored grey blazer, with soft natural light illuminating her face. The background is a blurred high-end office with glass partitions and indoor plants, maintaining the sophisticated and professional aesthetic of the design system." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCQOzz6iVLdzSeZG23knxfsgKnh6TDrYv_9BzsvH6b9fF0kqFOvWykCSMtHNXBajqhjsouHCn_dO_xRo-YD2DY7-JsfjIBGItHXTwJpHf4Q87u4dQPIhE-x9bRuf6nunZcag0pAz_mTNWFmYlYtKk2sRgUSTamEGQyPVjgZ4zQo5gVK5tKXT7CdTofPlgVeHXOx9X7F2km4eSpwcIO_QuE77L4tEeaDHPryWildNZwLQWWVWli6UQ5DVo_Bgwp7yxD7hXwl5dS9u9o"/>
</div>
<div>
<p class="font-label-md text-on-background uppercase tracking-widest">Amanda Wijaya</p>
<p class="font-body-md text-on-surface-variant">CEO, TechVanguard Studio</p>
</div>
</div>
</div>
</section>
