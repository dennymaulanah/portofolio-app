...
<body class="font-body-md text-body-md">
    ...
    <nav class="sticky top-0 z-50 w-full bg-surface/70 backdrop-blur-xl border-b border-white/10 shadow-sm transition-all h-16 md:h-20">
        <div class="flex justify-between items-center max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop h-full">
            <div class="flex items-center gap-3">
                ...
                <span class="font-display text-[20px] md:text-headline-md font-bold text-primary">AzeriaDev</span>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="#" class="btn-primary text-white px-4 py-2 sm:px-6 sm:py-2 rounded-full font-label-md text-[12px] sm:text-label-md flex items-center gap-2 hidden sm:flex">
                    Hire Me
    ...
    <div class="mobile-menu md:hidden" id="mobileMenu">
        ...
        <div class="p-4 mt-2">
            <a href="#" class="btn-primary text-white w-full py-3.5 rounded-xl font-label-md flex items-center justify-center gap-2">
                Hire Me
                <span class="material-symbols-outlined text-[18px]">arrow_forward</span>
            </a>
        </div>
